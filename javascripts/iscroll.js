...
iScroll.prototype = {
  ...
  swipe: function(e, p) {},
	...
	handleEvent: function (e) {
        ...
        break;
			...
			case END_EVENT:
				that.touchEnd(e);
				that.swipe(e, {
          direction: that.swipeDirectionX < 0 ? 'left' : 'right',
          deltaX: that.swipeDirectionX,
          deltaY: that.swipeDirectionY
        });
        break;
	...
	refresh: function () {
		...
		that.directionX = 0;
		that.directionY = 0;
		that.swipeDirectionX = 0;
		that.swipeDirectionY = 0;
	...
	touchMove: function(e) {
      ...
      leftSwipeDelta = pageX - that.swipeStartX;
      topSwipeDelta = pageY - that.swipeStartY;
		
    that.swipeDirectionX = leftSwipeDelta;
		that.swipeDirectionY = topSwipeDelta;
